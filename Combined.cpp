...
void find_shortest_path_5(int distance[6][6]) {
    int minPath = 100000;
    int firstCity = 0;
    int path[6];
        ...
        for (int thirdCity = 1; thirdCity <= 4; thirdCity++) {
            for (int fourthCity = 1; fourthCity <= 4; fourthCity++) {
                for (int fifthCity = 1; fifthCity <= 4; fifthCity++) {
                    ...
                    int orderOfCitiesInPath[6] = { firstCity, secondCity, thirdCity, fourthCity, fifthCity };
                    bool citiesDifferent = true;
...
void find_shortest_path_4(int distance[6][6]) {
    int minPath = 100000;
    int firstCity = 0;
    int path[5];
    for (int secondCity = 1; secondCity <= 3; secondCity++) {
        for (int thirdCity = 1; thirdCity <= 3; thirdCity++) {
            for (int fourthCity = 1; fourthCity <= 3; fourthCity++) {

                int orderOfCitiesInPath[6] = {firstCity, secondCity, thirdCity, fourthCity};
                bool citiesDifferent = true;
                for (int firstIndex = 0; firstIndex <= 5; firstIndex++) {
                    for (int secondIndex = 0; secondIndex <= 5; secondIndex++) {
                        if (firstIndex != secondIndex) {
